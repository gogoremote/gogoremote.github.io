webpackJsonp([5,12,19,29,33,34,56,57],{
...
// module
exports.push([module.i, ".tabs .overview-tab .explore-row[data-v-6e5a223c]{display:none!important}.tabs .maps-tab[data-v-6e5a223c]{height:500px}.chat-widget[data-v-6e5a223c],.profile-card-widget[data-v-6e5a223c]{width:100%}.chat-widget .widget-body[data-v-6e5a223c],.profile-card-widget .widget-body[data-v-6e5a223c]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.bottom-widgets>div[class^=col]>div[data-v-6e5a223c],.chat-widget .widget-body>div[data-v-6e5a223c],.profile-card-widget .widget-body>div[data-v-6e5a223c]{width:100%}", "", {"version":3,"sources":["C:/xampp/htdocs/gogotest2/src/components/gogoboard/Gogoboard.vue"],"names":[],"mappings":"AACA,kDACE,sBAAyB,CAC1B,AACD,iCACE,YAAc,CACf,AACD,oEAEE,UAAY,CACb,AACD,8FAEI,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,wBAAyB,AACrB,qBAAsB,AAClB,uBAAwB,AAChC,yBAA0B,AACtB,sBAAuB,AACnB,kBAAoB,CAC/B,AAKD,2JACE,UAAY,CACb","file":"Gogoboard.vue","sourcesContent":["\n.tabs .overview-tab .explore-row[data-v-6e5a223c] {\n  display: none !important;\n}\n.tabs .maps-tab[data-v-6e5a223c] {\n  height: 500px;\n}\n.profile-card-widget[data-v-6e5a223c],\n.chat-widget[data-v-6e5a223c] {\n  width: 100%;\n}\n.profile-card-widget .widget-body[data-v-6e5a223c],\n  .chat-widget .widget-body[data-v-6e5a223c] {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n}\n.profile-card-widget .widget-body > div[data-v-6e5a223c],\n    .chat-widget .widget-body > div[data-v-6e5a223c] {\n      width: 100%;\n}\n.bottom-widgets > div[class^='col'] > div[data-v-6e5a223c] {\n  width: 100%;\n}\n"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__gogo_elements_MotorPanel_vue__ = __webpack_require__("KxAR");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gogo_elements_SensorPanel_vue__ = __webpack_require__("FAyG");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gogo_elements_DisplayPanel_vue__ = __webpack_require__("+o6u");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__gogo_elements_PingPanel_vue__ = __webpack_require__("L/5s");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vuex__ = __webpack_require__("NYxO");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_services_deviceControl__ = __webpack_require__("Ilkg");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    MotorPanel: __WEBPACK_IMPORTED_MODULE_1__gogo_elements_MotorPanel_vue__["default"],
    SensorPanel: __WEBPACK_IMPORTED_MODULE_2__gogo_elements_SensorPanel_vue__["default"],
    DisplayPanel: __WEBPACK_IMPORTED_MODULE_3__gogo_elements_DisplayPanel_vue__["default"],
    PingPanel: __WEBPACK_IMPORTED_MODULE_4__gogo_elements_PingPanel_vue__["default"]
  },
  data: function data() {
    return {
      count: 1
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_6_services_deviceControl__["a" /* default */].setSocket(this.$socket);
    this.$bus.$on('startGogoTour', function () {
      _this2.startTourIfNever();
    });
  },
  ...
  computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_5_vuex__["b" /* mapGetters */])(['gogo'])),
  methods: {
    startTour: function startTour() {
      ...
      var enjoyhintSteps = [{ 'next .gogo-image-display': 'GoGo Board status. <br>A picture of the board should show up here if it is <text class="hint-blue">connected</text> and <text class="hint-orange">turned on</text>.'
    ...
    startTourIfNever: function startTourIfNever() {
      if (!this.hasStartedTour()) {
        this.startTour();
      }
    },
    hasStartedTour: function hasStartedTour() {
      return this.$localStorage.get('hasStartedTour');
    },
    setHasStartedTour: function setHasStartedTour() {
      this.$localStorage.set('hasStartedTour', true);
    },
    handleDisplayHeaderClick: function handleDisplayHeaderClick() {
      this.startTour();
    }
  }
});
...
// load the styles
var content = __webpack_require__("1iTf");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("ca35e73e", content, true);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Gogoboard_vue__ = __webpack_require__("25Eo");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6e5a223c_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Gogoboard_vue__ = __webpack_require__("nIJg");
function injectStyle (ssrContext) {
  __webpack_require__("2e25")
  __webpack_require__("ztHf")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6e5a223c"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Gogoboard_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6e5a223c_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Gogoboard_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"extra"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-12 col-lg-7 offset-lg-0 col-xl-6 offset-xl-1"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-6 d-flex"},[_c('vuestic-widget',{staticClass:"chat-widget",attrs:{"headerBgColor":'#a5d442',"headerTextColor":'#fbfff3',"icon":(_vm.gogo.info.boardType == 0 ? 'fa-warning' : 'fa-plug'),"headerClickAction":_vm.handleDisplayHeaderClick,"headerText":_vm.$t( _vm.gogo.info.boardType == 0 ? 'gogoboard.headers.is_not_connected' : 'gogoboard.headers.is_connected')}},[_c('display-panel',{attrs:{"info":_vm.gogo.info}})],1)],1),_vm._v(" "),_c('div',{staticClass:"col-md-6 d-flex"},[_c('vuestic-widget',{staticClass:"chat-widget",attrs:{"icon":'fa-question',"headerBgColor":'#607d8d',"headerTextColor":'#fbfff3',"headerText":_vm.$t('gogoboard.headers.ping')}},[_c('ping-panel',{attrs:{"irValue":_vm.gogo.irValue}})],1)],1)]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-12"},[_c('vuestic-widget',{staticClass:"chat-widget sensor-widget",attrs:{"icon":'fa-thermometer-three-quarters',"headerBgColor":'#db3f8d',"headerTextColor":'#f3dde8',"headerText":_vm.$t('gogoboard.headers.sensors')}},[_c('sensor-panel')],1)],1)])]),_vm._v(" "),_c('div',{staticClass:"col-md-8 offset-md-2 col-lg-5 offset-lg-0 col-xl-4 d-flex"},[_c('vuestic-widget',{staticClass:"chat-widget",attrs:{"icon":'fa-toggle-on',"headerBgColor":'#f3a73c',"headerTextColor":'#fff0dc',"headerText":_vm.$t('gogoboard.headers.motors')}},[_c('motor-panel')],1)],1)])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
// module
exports.push([module.i, ".hint-blue{color:#00ebe7}.hint-green-blue{color:#1ecd97}.hint-red{color:#ff4136}.hint-orange{color:#ff9500}.hint-pink{color:#ff0080}", "", {"version":3,"sources":["C:/xampp/htdocs/gogotest2/src/components/gogoboard/Gogoboard.vue"],"names":[],"mappings":"AACA,WACE,aAAe,CAChB,AACD,iBACE,aAAe,CAChB,AACD,UACE,aAAe,CAChB,AACD,aACE,aAAe,CAChB,AACD,WACE,aAAe,CAChB","file":"Gogoboard.vue","sourcesContent":["\n.hint-blue {\n  color: #00ebe7;\n}\n.hint-green-blue {\n  color: #1ecd97;\n}\n.hint-red {\n  color: #ff4136;\n}\n.hint-orange {\n  color: #ff9500;\n}\n.hint-pink {\n  color: #ff0080;\n}\n"],"sourceRoot":""}]);
...
// load the styles
var content = __webpack_require__("xV8L");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("5ad3f6fb", content, true);

/***/ })

});
//# sourceMappingURL=5.5134d6614444e1059b9c.js.map